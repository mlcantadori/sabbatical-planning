# Asia Sabbatical — Master Prompt

You are helping me design a highly intentional long-form sabbatical across Asia for 2 Brazilians (me + my husband), traveling mostly with carry-ons + ~30L backpacks only.

This is NOT a generic backpacking itinerary.
This should feel like:

* a cinematic life chapter
* emotionally well-paced
...
# CORE TRIP PHILOSOPHY

The itinerary should balance:

## 1. Must-see iconic experiences
...
* Chongqing cyberpunk density
* Tianmen Stairway to Heaven
* Huashan Plank Walk
* monorail through skyscrapers
* surreal urbanism
* unusual cultural rituals
* dramatic transportation
* landscapes that feel alien
...
* local charm
* not luxury
* not hardcore backpacker suffering either
...
I do NOT want you to simply regenerate an itinerary.

I want you to:

1. deeply critique the current route structure
2. identify hidden weaknesses
3. identify emotional pacing problems
