...
(function () {
  ...
  const CITY = {
    rio: 'Rio de Janeiro', cumbuco: 'Cumbuco', saopaulo: 'São Paulo',
    toronto: 'Toronto', athens: 'Athens', turkey: 'Istanbul', baku: 'Baku',
    india: 'Delhi', nepal: 'Kathmandu', 'japan-autumn': 'Tokyo',
    korea: 'Seoul', taiwan: 'Taipei', 'china-1': 'Beijing', hk: 'Hong Kong',
    'japan-winter': 'Hakuba', philippines: 'Coron', 'indonesia-1': 'Sorong',
    'indonesia-2': 'Bali', borneo: 'Kota Kinabalu', singapore: 'Singapore',
    malaysia: 'Kuala Lumpur', thailand: 'Bangkok', 'china-2': 'Guilin',
  };
