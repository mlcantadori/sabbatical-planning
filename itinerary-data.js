...
window.TRIP = (function () {
    ...
    },
    {
      ...
      places: [
        { name: 'Cappadocia — Göreme', days: 3, query: 'Göreme, Cappadocia, Turkey',
          highlights: ['Sep 21 arrival in Göreme from Athens via IST — single Turkish ticket, bought ✅','Explore the valleys: Rose Valley, Love Valley, Göreme Open Air Museum','Hot air balloon flight — Sep 22 or 23','Underground cities: Derinkuyu, Kaymakli','Sep 24, 22:50: fly Kayseri (ASR) → Izmir (ADB)'] },
        { name: 'Alaçatı', days: 3, query: 'Alaçatı, Çeşme, Turkey',
          highlights: ['Pick up the rental car directly at ADB — ~1h drive west to Alaçatı','Kitesurfing window on the Çeşme peninsula','Cobblestone village, windmills, Aegean coastline','Stone-house streets, slow mornings, natural wine bars'] },
        { name: 'Kaş', days: 3, query: 'Kaş, Antalya, Turkey',
          highlights: ['Drive south down the coast from Alaçatı','Kaputaş Beach','Lycian Way treks from town','Sep 30: ~5.5h drive Kaş → Izmir (ADB), drop the car'] },
        { name: 'Istanbul', days: 10, query: 'Sultanahmet, Istanbul',
          highlights: ['Sep 30 evening flight ADB → Istanbul (~1h15)','Historic peninsula: Hagia Sophia, Topkapi, Sultanahmet without rushing','Asian side — Kadıköy/Moda ferries and market mornings','Bosphorus ferries — the most beautiful commute on Earth','Princes\' Islands day trip','Oct 10: fly Istanbul → Delhi (to buy — Indigo/Turkish direct ~6h30)'] },
      ],
      booking: ['Balloon for Sep 22/23 — book within 1–2 weeks; confirm Göreme pickup','Istanbul → Delhi Oct 10 — buy by early Aug (~€480 couple)','Stays: Göreme (Sep 21–24), Alaçatı (24–27), Kaş (27–30), Istanbul (Sep 30 – Oct 10)','Rental car ADB Sep 24 – 30 — collect directly at ADB and return there after Kaş→Izmir drive','Internal flights ASR→ADB at 22:50 Sep 24 + ADB→IST evening Sep 30 — Pegasus/AJet/SunExpress, 6–8 weeks out','India e-Visa by mid-Sep'],
      decisions: ['Göreme as the Cappadocia base — valleys, balloon logistics, Open Air Museum','Coastal loop by rental car (Alaçatı + Kaş) instead of Şirince/Pamukkale','Istanbul as a 10-night close covering the historic peninsula, Asian side, and the Bosphorus'],
    },
    {
  ...
  const bookings = [
    ...
    { task: 'Istanbul → Delhi flight — Oct 10',         by: 'By early Aug 2026',     critical: true,  notes: 'Indigo/Turkish direct ~6h30, ~€480 couple — monitor price' },
    { task: 'Türkiye stays: Göreme · Alaçatı · Kaş · Istanbul', by: 'Jul–Aug 2026', critical: false, notes: 'Sep 21–24 / 24–27 / 27–30 / Sep 30–Oct 10' },
    { task: 'Rental car ADB — Sep 24 to 30',            by: 'Jul–Aug 2026',         critical: false, notes: 'Collect directly at Izmir (ADB), return to ADB after Kaş→Izmir drive' },
    { task: 'Türkiye internal flights',                 by: '6–8 weeks out (early Aug)', critical: false, notes: 'ASR→ADB at 22:50 Sep 24 · ADB→IST evening Sep 30 — Pegasus/AJet/SunExpress' },
    { task: 'India e-Visa',                             by: 'By mid-Sep 2026',       critical: false, notes: 'Before the Oct 10 flight to Delhi' },
