...
window.TRIP = (function () {
  ...
  const chapters = [
    ...
    },
    {
      ...
      intro: 'Landing from Athens on a single Turkish ticket via IST into Göreme. Three nights in the valleys, then fly ASR→ADB for a rental-car loop: Alaçatı kitesurfing and five nights in Kaş for diving and the Lycian Way. Drive back to Izmir on Oct 3, evening hop into Istanbul, six nights on both shores before the Oct 9 flight to Delhi.',
      ...
      places: [
        { name: 'Cappadocia — Göreme', days: 3, query: 'Göreme, Cappadocia, Turkey',
          highlights: ['Sep 21 arrival in Göreme from Athens via IST — single Turkish ticket, bought ✅','Explore the valleys: Rose Valley, Love Valley, Göreme Open Air Museum','Hot air balloon flight — Sep 22 or 23','Underground cities: Derinkuyu, Kaymakli','Sep 24 fly Kayseri (ASR) → Izmir (ADB)'] },
        { name: 'Alaçatı', days: 4, query: 'Alaçatı, Çeşme, Turkey',
          highlights: ['Pick up rental car at ADB — ~1h drive west to Alaçatı','Kitesurfing window on the Çeşme peninsula','Cobblestone village, windmills, Aegean coastline','Stone-house streets, slow mornings, natural wine bars'] },
        { name: 'Kaş', days: 5, query: 'Kaş, Antalya, Turkey',
          highlights: ['Drive south down the coast from Alaçatı','Scuba diving — the chapter dive anchor','Kaputaş Beach','Lycian Way treks from town','Oct 3: ~5.5h drive Kaş → Izmir (ADB), drop the car'] },
        { name: 'Istanbul', days: 6, query: 'Sultanahmet, Istanbul',
          highlights: ['Oct 3 evening flight ADB → Istanbul (~1h15)','Historic peninsula: Hagia Sophia, Topkapi, Sultanahmet without rushing','Asian side — Kadıköy/Moda ferries and market mornings','Bosphorus ferries — the most beautiful commute on Earth','Princes\' Islands day trip','Oct 9 night: fly Istanbul → Delhi (to buy — Indigo/Turkish direct ~6h30)'] },
      ],
      booking: ['Balloon for Sep 22/23 — book within 1–2 weeks; confirm Göreme pickup','Istanbul → Delhi Oct 9 night — buy by early Aug (~€480 couple)','Stays: Göreme (Sep 21–24), Alaçatı (24–28), Kaş (28 – Oct 3), Istanbul (Oct 3–9)','Rental car ADB Sep 24 – Oct 3 — one-way loop back to ADB','Internal flights ASR→ADB Sep 24 + ADB→IST evening Oct 3 — Pegasus/AJet/SunExpress, 6–8 weeks out','India e-Visa by mid-Sep'],
      decisions: ['Göreme as the Cappadocia base — valleys, balloon logistics, Open Air Museum','Coastal loop by rental car (Alaçatı + Kaş) instead of Şirince/Pamukkale','Istanbul as a 6-night close covering the historic peninsula, Asian side, and the Bosphorus'],
    },
    {
      id: 'india', num: 7, kind: 'chapter', region: 'himalaya',
      country: 'India', flag: '🇮🇳', title: 'India',
      start: '2026-10-10', end: '2026-10-21', days: 11,
      ...
      places: [
        { name: 'Delhi + Agra', days: 2, query: 'Taj Mahal, Agra',
          highlights: ['Land in Delhi from Istanbul, express train to Agra','Taj Mahal at sunrise — arrive 6am, before tour groups, in golden light','Agra Fort','Mehtab Bagh — sunset Taj view across the river'] },
        { name: 'Rishikesh', days: 5, query: 'Rishikesh, India',
        ...
        { name: 'Varanasi', days: 4, query: 'Varanasi ghats, India',
          highlights: ['Ghats at dawn — rowing on the Ganges in morning mist','Ganga Aarti at dusk — fire, flowers, bells, priests','Manikarnika cremation ghats','Sarnath — where Buddha first taught, 10km out','Chai, silk, wandering the narrow alleys','Fly Varanasi → Kathmandu (direct, ~1h)'] },
      ],
      booking: [],
    },
    {
  ...
  const bookings = [
    ...
    { task: 'Cappadocia balloon — Sep 22 or 23',        by: 'Next 1–2 weeks',        critical: true,  notes: 'CONFIRM Göreme pickup before paying' },
    ...
    { task: 'Türkiye stays: Göreme · Alaçatı · Kaş · Istanbul', by: 'Jul–Aug 2026', critical: false, notes: 'Sep 21–24 / 24–28 / 28–Oct 3 / Oct 3–9' },
    { task: 'Rental car ADB — Sep 24 to Oct 3',         by: 'Jul–Aug 2026',         critical: false, notes: 'Pick up Izmir (ADB), drop ADB after Kaş→Izmir drive' },
    { task: 'Türkiye internal flights',                 by: '6–8 weeks out (early Aug)', critical: false, notes: 'ASR→ADB Sep 24 · ADB→IST evening Oct 3 — Pegasus/AJet/SunExpress' },
    { task: 'India e-Visa',                             by: 'By mid-Sep 2026',       critical: false, notes: 'Before the Oct 9 flight to Delhi' },
    { task: 'Close-to-date: Crete car · Samaria + Balos · Kleftiko', by: 'On the road, 2–3 days ahead', critical: false, notes: 'Boat tours are weather-dependent — book short' },
    ...
    chapterAnchors: [
      {
        ...
        items: [
          ...
          'Türkiye: ASR→ADB + ADB→IST ~€170 · ADB rental car ~9d · Istanbulkart ~€50 · IST→Delhi ~€480',
