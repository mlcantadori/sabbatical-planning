...
window.TRIP = (function () {
  ...
  const bookings = [
    ...
    { task: 'Flights Nov–Jan + China domestic hops', by: 'By Sep 2026', critical: true, notes: 'KTM→TPE Nov 9 · TPE→CAN Nov 24 · HKG→CTU Dec 7 · PVG→ICN Dec 20 · ICN→SHA Jan 7 · SHA→KIX Jan 25 · TYO→MNL Feb 24 · domestic HSR/flights: CAN→SZX, CTU→CKG, CKG→ZJJ, ZJJ→PVG' },
