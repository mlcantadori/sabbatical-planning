...
window.TRIP = (function () {
  ...
  const chapters = [
    ...
    },
    {
      ...
      start: '2027-03-11', end: '2027-03-22', days: 11,
      theme: 'The best diving on Earth — liveaboard deep dive',
      intro: 'Raja Ampat contains the highest marine biodiversity on the planet. More fish species in one bay than in the entire Caribbean. Board on arrival day, 10 days on the water Mar 11–20, transit back to Bali. NOTE: VOA Day 1 ~Mar 11 — extend +30d in Bali (~$60) to cover the Apr 18 exit.',
      tldr: 'Board Mar 11 · 10d liveaboard Mar 11–20 · Back to Bali',
    ...
    },
    {
      ...
      start: '2027-03-22', end: '2027-04-18', days: 27,
      theme: 'Slow Ubud recovery, raw cliffs, dragon islands, volcanic sunrise — close of Indonesia block',
      intro: 'Ten slow days in Ubud recovering from the liveaboard, then three distinct Indonesian worlds back to back. Nusa Penida: stark, dramatic, manta-filled. Komodo: dragons and world-class drift dives. Bali: rice terraces and a volcano at 3am. VOA extended +30d in Bali — exits via KK Apr 18 ✓',
      tldr: 'Ubud slow · Nusa Penida · Komodo · Mount Batur sunrise',
  ...
  const budget = {
    ...
    chapters: [
      ...
      { id: 'indonesia-1', days: 11, lodging: 110, food: 120, transport: 1200, activities: 8400, fees: 120, note: 'Liveaboard $8,400 locked (Mar 11–20) · to/from Sorong flights ~$1,200 · VOA + extension' },
      { id: 'indonesia-2', days: 27, lodging: 1250, food: 1350, transport: 600, activities: 1210, fees: 0, note: 'Ubud slow 10n ~$550 · Komodo 3D2N boat ~$440 + park ~$80 · dives ~$570 · Batur ~$120' },
