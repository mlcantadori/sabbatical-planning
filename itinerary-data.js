...
window.TRIP = (function () {
    ...
    },
    {
      ...
      places: [
        { name: 'Kathmandu', days: 3, query: 'Kathmandu, Nepal',
          highlights: ['Arrive Oct 21 from Varanasi (08:30 direct — booked ✅)','Boudhanath Stupa — one of the largest stupas on Earth','Pashupatinath Temple — sacred Hindu cremation ghats on the Bagmati','Swayambhunath (Monkey Temple)','Altitude acclimatization, gear check, ACAP + TIMS permits'] },
    ...
    },
    {
      ...
      places: [
        ...
        { name: 'Shanghai buffer', days: 3, query: 'Jing\'an, Shanghai',
          highlights: ['Final meals, laundry, trip planning','Last look at the Bund in autumn light','Slow days — fly Shanghai → Shenzhen Nov 28 (in-chapter hop)'] },
  ...
  const budget = {
    ...
    chapters: [
      ...
      { id: 'china-e1', days: 26, lodging: 2230, food: 1690, transport: 980, activities: 500, fees: 0, note: 'Shanghai 9n + HSR star + Shenzhen friends finale + Cantonese blitz · PVG→SZX hop in-chapter' },
      ...
      { id: 'china-e2', days: 13, lodging: 985, food: 845, transport: 830, activities: 330, fees: 0, note: 'PEK→CTU ~$350 + CTU→CKG HSR ~$120 + CKG→PVG ~$240 · Wall + pandas + hotpot slow day' },
  ...
  const optimalWindows = {
    ...
    'china-e1':    { months: [11, 12],           note: 'Nov–Dec: Jiangnan autumn + PRD friends finale, one 26-day stay' },
    'china-e2':     { months: [12],                note: 'Dec: Great Wall in crisp light; Sichuan hotpot season' },
