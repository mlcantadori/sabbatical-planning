...
window.TRIP = (function () {
  ...
  const chapters = [
    ...
    },
    {
      ...
      places: [
        ...
        { name: 'Alaçatı', days: 3, query: 'Alaçatı, Çeşme, Turkey',
          highlights: ['Pick up the rental car directly at ADB — ~1h drive west to Alaçatı','Kitesurfing window on the Çeşme peninsula','Cobblestone village, windmills, Aegean coastline','Stone-house streets, slow mornings, natural wine bars','Stays Alaçatı Sep 24–27 booked ✅'] },
    ...
    },
    {
      ...
      intro: 'A compact, intentional India compressed by the Baku routing: land in Delhi Oct 14 from Baku, straight to the Taj, then Rishikesh for yoga, river, and mountain air, closing with Varanasi at full spiritual intensity before flying direct to Kathmandu.',
      tldr: 'Delhi · Agra · Rishikesh · Varanasi (via Baku)',
      ...
      places: [
        { name: 'Delhi + Agra', days: 1, query: 'Taj Mahal, Agra',
          highlights: ['Land in Delhi Oct 14 from Baku (IST → GYD Oct 12 → DEL Oct 14)','Taj Mahal at sunrise — arrive 6am, before tour groups, in golden light','Agra Fort','Mehtab Bagh — sunset Taj view across the river'] },
  ...
  const bookings = [
    ...
    { task: 'Flights until DEL — all bought', by: 'Done ✅', critical: false, done: true, notes: 'ASR→ADB Sep 24 22:50 · ADB→IST Sep 30 eve · IST→GYD Oct 12 · GYD→DEL Oct 14' },
    { task: 'Türkiye stays until Izmir — all booked', by: 'Done ✅', critical: false, done: true, notes: 'Göreme Sep 21–24 · Alaçatı Sep 24–27 · Kaş Sep 27–30' },
