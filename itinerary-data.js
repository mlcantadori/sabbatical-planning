...
window.TRIP = (function () {
  ...
  const chapters = [
    ...
    },
    {
      ...
      start: '2026-11-10', end: '2026-11-28', days: 18,
      theme: 'Jiangnan autumn: foliage canals, open ridges, slow cities',
      intro: 'First mainland entry opens in Jiangnan autumn — 18 days that begin a 26-day continuous stay with the PRD leg (deep inside the 30-day limit, no reset needed between them). Shanghai as slow post-trek landing, Suzhou and Hangzhou gardens at foliage peak, and Huangshan with West Sea Canyon still open before its December closure. All linked by bullet train, all mild.',
      tldr: 'Shanghai · Huangshan · Hangzhou · Suzhou',
      weather: { hi: 15, lo: 9, label: 'Jiangnan autumn, 15°/9°', emoji: '🍁', rainyDays: 6 },
      photos: ['shanghai bund night', 'shanghai french concession'],
      places: [
        { name: 'Shanghai', days: 6, query: 'The Bund, Shanghai',
          highlights: ['Fly in from Kathmandu Nov 10 — French Concession autumn color, café season, no heating worries','The Bund — skyline across the Huangpu, best at night','Yu Garden — classical garden in autumn quiet','Tianzifang arts + crafts alleys','Xintiandi, M50 art district','HSR Shanghai → Huangshan (~2.5h) Nov 16'] },
        { name: 'Huangshan', days: 3, query: 'Huangshan, Anhui',
          highlights: ['Yellow Mountain — autumn foliage + early rime, sea of clouds','West Sea Canyon OPEN (closes Dec–Mar) — the canyon loop the winter plan missed','Bright Summit sunrise above the cloud sea','Hot springs at the mountain foot','Windproof shell + traction spikes in Tangkou if icy','Cable cars: autumn schedule, front-load days; book summit hotel ~3 days ahead','HSR Huangshan → Hangzhou Nov 19'] },
        { name: 'Hangzhou', days: 3, query: 'West Lake, Hangzhou',
          highlights: ['West Lake in autumn color — Broken Bridge, Su Causeway, golden gingkoes','Lingyin Temple in cedar quiet','Meijiawu tea village — post-harvest calm, unhurried tastings','Hefang Street old town','HSR Hangzhou → Suzhou (~1.5h) Nov 22'] },
        { name: 'Suzhou', days: 3, query: 'Humble Administrator\'s Garden, Suzhou',
          highlights: ['Humble Administrator\'s Garden + Lion Grove in autumn color — peak week','Tongli water town day trip — misty canals, empty bridges','Pingjiang Road canals at dusk (skip the Silk Museum for lived-in lanes)','HSR Suzhou → Shanghai (~30min) Nov 25'] },
        { name: 'Shanghai buffer', days: 3, query: 'Jing\'an, Shanghai',
          highlights: ['Final meals, laundry, trip planning','Last look at the Bund in autumn light','Slow final days — fly Shanghai → Shenzhen Nov 28'] },
      ],
    },
    {
      id: 'china-e1a', kind: 'chapter', region: 'middle',
      country: 'China', flag: '🇨🇳', title: 'China',
      start: '2026-11-28', end: '2026-12-06', days: 8,
      theme: 'Cantonese immersion + friends in Shenzhen',
      intro: 'Second leg of the 26-day continuous stay (8 counted days — same admission as Jiangnan, no reset needed). Land in Shenzhen for friends\' finale, then Guangzhou for the Cantonese blitz before the HSR slide into Hong Kong.',
      tldr: 'Shenzhen (friends ✓) · Guangzhou',
      ...
      places: [
        { name: 'Shenzhen', days: 4, query: 'Shekou, Shenzhen',
          highlights: ['Fly PVG → Shenzhen Nov 28','Four full days with friends (in town Nov 23 – Dec 2 ✓ — catch their finale!)','Huaqiangbei Electronics Market — world\'s largest, floors of components','OCT-LOFT Contemporary Art District','Dapeng Peninsula coastal hike','Dafen Oil Painting Village (pass-through only)','HSR Shenzhen → Guangzhou (~1h) Dec 2'] },
    ...
    },
    {
      ...
      start: '2026-12-06', end: '2026-12-11', days: 5,
      theme: 'Neon city + dim sum + visa reset, priced before Christmas week',
      intro: 'Five early-December days: dry 20° air, early WinterFest lights, the cheapest hotel week of the season — the 30-day visa clock resets for the Beijing leg, and a Monday-morning errand files the Taiwan visitor visas for January. A proper chapter, not transit.',
      ...
      places: [
        { name: 'Hong Kong', days: 5, query: 'Victoria Peak, Hong Kong',
          highlights: ['Victoria Peak — harbor panorama at dusk, city grid below','Star Ferry crossing: Kowloon → Central at night','Dim sum yum cha: Tim Ho Wan, Lin Heung, One Dim Sum','Taiwan visitor-visa filing at TECO Dec 7 (morning errand — pickup Dec 8–9)','Temple Street Night Market — jade, fortune tellers, street food','Nan Lian Garden + Chi Lin Nunnery (free, stunning)','Lamma Island day trip: seafood lunch, car-free village walk','Rest, laundry, planning — fly HK → Beijing Dec 11'] },
      ],
    },
    {
      id: 'china-e1b', kind: 'chapter', region: 'middle',
      country: 'China', flag: '🇨🇳', title: 'China',
      start: '2026-12-11', end: '2026-12-24', days: 13,
      theme: 'Great Wall first, then Sichuan fire',
      intro: 'Second mainland entry (13 counted days — clock reset in Hong Kong). The most important sight goes first while winter light is crisp: an empty, possibly snow-dusted Great Wall. Then west for panda mornings and hotpot nights, closing in cyberpunk Chongqing before exiting via Shanghai to Seoul.',
      ...
      places: [
        { name: 'Beijing', days: 5, query: 'Mutianyu Great Wall, Beijing',
          highlights: ['Fly HK → Beijing Dec 11','Great Wall (Mutianyu) — empty + snow-dusted, pick the bluest morning','Forbidden City in crisp winter light (closed Mondays — Dec 14 out)','Temple of Heaven','798 Art District','Hutong + Drum/Bell Towers','Peking duck','Down layers from Guangzhou Uniqlo','Fly Beijing → Chengdu Dec 16'] },
  ...
  const bookings = [
    ...
    { task: 'Flights Nov–Jan + China domestic hops', by: 'By Sep 2026', critical: true, notes: 'KTM→PVG Nov 9 · PVG→SZX Nov 28 · SZX→CAN HSR Dec 2 · CAN→HK HSR Dec 6 · HKG→PEK Dec 11 · PEK→CTU Dec 12 · CKG→PVG Dec 23 · PVG→ICN Dec 24 (+ICN→PUS hop) · ICN→TPE Jan 11 · TPE→KIX Jan 25 · domestic HSR: CTU→CKG' },
    { task: 'Taiwan visitor visa (2 pax)', by: 'File TECO Hong Kong Dec 7', critical: true, notes: 'Morning errand, pickup Dec 8–9; request 30d grant for Jan 11–25 stay; fallback Seoul filing; do not ticket ICN→TPE until answered' },
  ...
  const budget = {
    ...
    chapters: [
      ...
      { id: 'china-e2', days: 18, lodging: 1590, food: 1170, transport: 650, activities: 400, fees: 0, note: 'Shanghai 9n + Huangshan/Hangzhou/Suzhou HSR star ~$480 · West Sea Canyon open · autumn gardens' },
      { id: 'china-e1a', days: 8, lodging: 640, food: 520, transport: 110, activities: 100, fees: 0, note: 'PVG→SZX fly-in + SZX→CAN→HK HSR exits · Canton Tower + Chen Clan + Kaiping day trip' },
      ...
      { id: 'china-e1b', days: 13, lodging: 985, food: 845, transport: 830, activities: 330, fees: 0, note: 'PEK→CTU ~$350 + CTU→CKG HSR ~$120 + CKG→PVG ~$240 · Wall + pandas + hotpot slow day' },
    ...
    flights: [
      ...
      { route: 'Kathmandu/Pokhara → Shanghai', cost: 550, date: '2026-11-09', note: 'Estimate ~$275pp, 1-stop via Chengdu' },
      { route: 'Shanghai → Shenzhen', cost: 220, date: '2026-11-28', note: 'Estimate, domestic trunk Saturday' },
      { route: 'Hong Kong → Beijing', cost: 350, date: '2026-12-11', note: 'Estimate' },
  ...
  const optimalWindows = {
    ...
    'china-e2':     { months: [11],                 note: 'Nov: foliage peak, West Sea Canyon open, mild Jiangnan' },
