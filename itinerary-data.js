...
window.TRIP = (function () {
  ...
  const chapters = [
    ...
    },
    {
      ...
      booking: ['Balloon Sep 22/23 — booked ✅','IST → GYD Oct 12 + GYD → DEL Oct 14 — bought ✅','Stays Göreme Sep 21–24 booked ✅ — Alaçatı (Sep 24–26, from Sep 24 for 1am arrival), Şirince (27), Kaş (28–30), Akyaka (Oct 1) need (re)booking for new dates','Rental car ADB Sep 25 – Oct 2 — collect at ADB, loop Alaçatı→Şirince→Kaş→Akyaka, return at ADB','Internal flights ASR→ADB 22:50 Sep 24 + ADB→IST Oct 2 — ASR→ADB bought ✅, ADB→IST to buy','India e-Visa by mid-Sep'],
  ...
  const budget = {
    ...
    chapters: [
      ...
      { id: 'turkey', days: 21, lodging: 1865, food: 1470, transport: 790, activities: 780, fees: 120, note: 'Göreme 3n + Alaçatı 3n (from Sep 24) + Şirince/Kaş/Akyaka + Istanbul 10n · balloon ~$480 · car 8d ~$450 · e-visa' },
    ...
    flights: [
      ...
      { route: 'Manila/Cebu → Sorong', cost: 700, date: '2027-03-19', note: 'Estimate' },
