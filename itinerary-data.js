...
window.TRIP = (function () {
  ...
  const chapters = [
    ...
    },
    {
      ...
      booking: ['Balloon for Sep 22/23 — book within 1–2 weeks; confirm Göreme pickup','Istanbul → Delhi Oct 9 night — buy by early Aug (~€480 couple)','Stays: Göreme (Sep 21–24), Alaçatı (24–27), Kaş (27–30), Istanbul (Sep 30 – Oct 9)','Rental car ADB Sep 24 – 30 — one-way loop back to ADB','Internal flights ASR→ADB Sep 24 + ADB→IST evening Sep 30 — Pegasus/AJet/SunExpress, 6–8 weeks out','India e-Visa by mid-Sep'],
      decisions: ['Göreme as the Cappadocia base — valleys, balloon logistics, Open Air Museum','Coastal loop by rental car (Alaçatı + Kaş) instead of Şirince/Pamukkale','Istanbul as a 9-night close covering the historic peninsula, Asian side, and the Bosphorus'],
    },
    {
  ...
  const bookings = [
    ...
    { task: 'Türkiye stays: Göreme · Alaçatı · Kaş · Istanbul', by: 'Jul–Aug 2026', critical: false, notes: 'Sep 21–24 / 24–27 / 27–30 / Sep 30–Oct 9' },
    { task: 'Rental car ADB — Sep 24 to 30',            by: 'Jul–Aug 2026',         critical: false, notes: 'Pick up Izmir (ADB), drop ADB after Kaş→Izmir drive' },
    { task: 'Türkiye internal flights',                 by: '6–8 weeks out (early Aug)', critical: false, notes: 'ASR→ADB Sep 24 · ADB→IST evening Sep 30 — Pegasus/AJet/SunExpress' },
