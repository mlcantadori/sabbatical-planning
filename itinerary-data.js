...
window.TRIP = (function () {
  ...
  const chapters = [
    ...
    },
    {
      ...
      start: '2026-11-11', end: '2026-11-25', days: 14,
      ...
      places: [
        ...
        { name: 'Tainan + south', days: 7, query: 'Tainan, Taiwan',
          highlights: ['Tainan temples, old streets, night markets — oyster omelettes and beef noodle soup','Anping old fort + treehouse','Kaohsiung harbor + Liuhe night market','Alishan day-trip option (or skip for slow days)','Return to Taipei — fly Taipei → Guangzhou Nov 25'] },
      ],
    },
    {
      id: 'china-e1a', kind: 'chapter', region: 'middle',
      country: 'China', flag: '🇨🇳', title: 'China',
      start: '2026-11-25', end: '2026-12-02', days: 7,
      theme: 'Cantonese immersion + friends in Shenzhen',
      intro: 'First mainland entry (7 counted days — deep inside the 30-day visa-free limit). Fly in from Taipei to Guangzhou for a Cantonese food blitz, then five days alongside friends in Shenzhen before the 15-minute HSR slide into Hong Kong.',
      ...
      places: [
        { name: 'Guangzhou', days: 3, query: 'Shamian Island, Guangzhou',
    ...
    },
    {
      ...
      intro: 'Second mainland entry (13 counted days — deep inside the limit, clock reset in Hong Kong). Fly in from HK to Chengdu for panda mornings and hotpot nights, ride the HSR to cyberpunk Chongqing, then close with four December days among the Avatar pillars — fog possible, Tianmen and the caves as backups. Exit via Shanghai to Seoul.',
      tldr: 'Chengdu · Chongqing · Zhangjiajie',
      weather: { hi: 12, lo: 3, label: 'Cool Sichuan, cold misty pillars, 12°/3°', emoji: '🌫️', rainyDays: 4 },
      photos: ['chengdu panda', 'chongqing cyberpunk night', 'zhangjiajie avatar pillars'],
      places: [
        { name: 'Chengdu', days: 4, query: 'Chengdu Panda Base',
          highlights: ['Fly HK → Chengdu Dec 7','Giant panda base — crisp winter morning, active bears','Jinli Ancient Street, Kuanzhai Alley','Teahouses + mapo tofu, dan dan noodles','Leshan Giant Buddha day trip option','Hotpot round one — winter is the season','HSR Chengdu → Chongqing (~1h) Dec 11'] },
        { name: 'Chongqing', days: 4, query: 'Chongqing, China',
          highlights: ['The most cyberpunk city on Earth — 34M people, bridges everywhere','Hongyadong stilted riverfront lit at night','Cable car across the Yangtze River','Hotpot capital — mandatory multiple visits','Dazu rock carvings day trip (tight but doable)','Travel to Zhangjiajie Dec 15'] },
        { name: 'Zhangjiajie', days: 4, query: 'Zhangjiajie National Park',
          highlights: ['Avatar Mountains in December — fog possible, snow-dusted pillars if lucky','Tianmen Stairway to Heaven (999 steps) — lower altitude, fog-immune','Baofeng Lake + Huanglong Cave backups for white-out days','Glass Bridge + Glass Cliff Walk','Traction spikes (~$10 in Wulingyuan) if icy','Down layers from Guangzhou Uniqlo'] },
        { name: 'Departure', days: 1, query: 'Shanghai Pudong Airport',
          highlights: ['Fly Zhangjiajie → Shanghai Dec 19','Overnight buffer before Korea','Fly Shanghai → Seoul Dec 20 — Korea begins'] },
      ],
    },
    {
    ...
    },
    {
      ...
      intro: 'Nineteen days: the northern capitals moved here for late-May perfection, then the southern karst at its greenest. Beijing at 24° instead of −8°, wall cycling in sunshine, lotus beginning on Kunming Lake — then mist in the karst, mirror terraces, and lantern light to close the trip.',
      tldr: 'Beijing · Xi\'an · Guilin · Longji · Fenghuang · Furong',
      weather: { hi: 28, lo: 18, label: 'Early summer, 28°/18°', emoji: '🐉', rainyDays: 8 },
      photos: ['xian terracotta warriors', 'guilin karst li river'],
      places: [
        ...
        { name: 'Fenghuang + Furong', days: 3, query: 'Fenghuang Ancient Town, China',
          highlights: ['Travel Guilin → Huaihua → Fenghuang Jun 13','Furong waterfall town — river pouring through the town center, Tujia stilt houses','Fenghuang riverside old town — lanterns over the Tuo River','Hong Bridge + diaojiaolou houses at dusk','Slow final full days'] },
  ...
  const bookings = [
    ...
    { task: 'Flights Nov–Jan + China domestic hops', by: 'By Sep 2026', critical: true, notes: 'KTM→TPE Nov 11 · TPE→CAN Nov 25 · HKG→CTU Dec 7 · PVG→ICN Dec 20 · ICN→SHA Jan 7 · SHA→KIX Jan 25 · TYO→MNL Feb 24 · domestic HSR/flights: CAN→SZX, CTU→CKG, CKG→ZJJ, ZJJ→PVG' },
  ...
  const budget = {
    ...
    chapters: [
      ...
      { id: 'china-e1a', days: 7, lodging: 560, food: 455, transport: 70, activities: 100, fees: 0, note: 'CAN→SZX HSR + SZX→HK exit · Canton Tower + Chen Clan' },
      { id: 'china-e1b', days: 13, lodging: 1040, food: 845, transport: 640, activities: 420, fees: 0, note: 'CTU→CKG HSR ~$120 · CKG→ZJJ + ZJJ→PVG ~$400 · pandas + Dazu + ZJJ/Tianmen' },
      ...
      { id: 'china-spring', days: 19, lodging: 1400, food: 1045, transport: 1180, activities: 320, fees: 0, note: 'BKK→PEK ~$450 + PEK→XIY HSR ~$150 + XIY→KWL ~$250 · Wall + Warriors + karst tickets' },
    ],
    ...
    flights: [
      ...
      { route: 'Taipei → Guangzhou', cost: 300, date: '2026-11-25', note: 'Estimate, cross-strait hop' },
      { route: 'Hong Kong → Chengdu', cost: 350, date: '2026-12-07', note: 'Estimate' },
  ...
  const optimalWindows = {
    ...
    'china-e1b':    { months: [12],                note: 'Dec: Sichuan hotpot season; Zhangjiajie winter gamble' },
