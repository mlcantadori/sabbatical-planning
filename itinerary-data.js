...
window.TRIP = (function () {
  ...
  const chapters = [
    ...
    },
    {
      ...
      intro: 'Landing from Athens on a single Turkish ticket via IST into Göreme. Three nights in the valleys (balloon Sep 22/23 cancelled — bad weather, fully refunded ✅), then take the Sep 24, 22:50 ASR→ADB flight for a rental-car loop down the Aegean coast: Alaçatı, Şirince (Ephesus), Kaş and Akyaka. Return the car at ADB on Oct 2, fly ADB → Istanbul 16:45 and stay until the end of the chapter before the Oct 12 flight to Baku.',
      ...
      places: [
        { name: 'Cappadocia — Göreme', days: 3, query: 'Göreme, Cappadocia, Turkey',
          highlights: ['Sep 21 arrival in Göreme from Athens via IST — single Turkish ticket, bought ✅','Explore the valleys: Rose Valley, Love Valley, Göreme Open Air Museum','Hot air balloon flight — Sep 22/23 cancelled (bad weather), full refund ✅','Underground cities: Derinkuyu, Kaymakli','Stays Göreme Sep 21–24 booked ✅','Sep 24, 22:50: fly Kayseri (ASR) → Izmir (ADB), bought ✅'] },
