...
window.TRIP = (function () {
  ...
  const chapters = [
    ...
    },
    {
      ...
      start: '2026-11-11', end: '2026-11-28', days: 17,
      ...
      places: [
        { name: 'Taipei', days: 6, query: 'Da\'an District, Taipei',
        ...
        { name: 'Tainan + south', days: 9, query: 'Tainan, Taiwan',
          highlights: ['Tainan temples, old streets, night markets — oyster omelettes and beef noodle soup','Anping old fort + treehouse','Alishan forest railway option (tea-country overnight)','Kaohsiung harbor + Liuhe night market','Return to Taipei — fly Taipei → Guangzhou Nov 28'] },
      ],
    },
    {
      id: 'china-e1', kind: 'chapter', region: 'middle',
      country: 'China', flag: '🇨🇳', title: 'China',
      start: '2026-11-28', end: '2026-12-15', days: 17,
      theme: 'Cantonese south + Sichuan fire, closing with friends in Shenzhen',
      intro: 'First mainland entry (17 counted days — deep inside the 30-day visa-free limit). Fly in from Taipei to Guangzhou for Cantonese food immersion, hop west to Chengdu and Chongqing for panda mornings and hotpot nights, then finish with five days alongside friends in Shenzhen before the 15-minute HSR slide into Hong Kong.',
      tldr: 'Guangzhou · Chengdu · Chongqing · Shenzhen (friends ✓)',
      weather: { hi: 20, lo: 10, label: 'Mild south, cool Sichuan, 20°/10°', emoji: '🏙️', rainyDays: 4 },
      photos: ['shenzhen night skyline', 'chengdu panda', 'chongqing cyberpunk night'],
      places: [
        { name: 'Guangzhou', days: 3, query: 'Shamian Island, Guangzhou',
          highlights: ['Cantonese food deep-dive — dim sum where it was born','Shamian Island colonial arcades','Chen Clan Academy — Lingnan craft at its finest','Canton Tower at night','Fly Guangzhou → Chengdu Dec 1'] },
        { name: 'Chengdu', days: 4, query: 'Chengdu Panda Base',
          highlights: ['Giant panda base — crisp winter morning, active bears','Jinli Ancient Street, Kuanzhai Alley','Teahouses + mapo tofu, dan dan noodles','Leshan Giant Buddha day trip option','Hotpot round one — winter is the season','HSR Chengdu → Chongqing (~1h) Dec 5'] },
    ...
    },
    {
      ...
      start: '2026-12-15', end: '2026-12-20', days: 5,
      theme: 'Neon city + dim sum + visa reset, priced before Christmas week',
      intro: 'Five pre-Christmas days: dry 20° air, early WinterFest lights, normal hotel prices — and the 30-day visa clock resets for the northern entry. A proper chapter, not transit.',
  ...
  const bookings = [
    ...
    { task: 'Flights Nov–Jan + China domestic hops', by: 'By Sep 2026', critical: true, notes: 'KTM→TPE Nov 11 · TPE→CAN Nov 28 · HKG→ICN Dec 20 · ICN→PEK Jan 7 · SHA→KIX Jan 25 · TYO→MNL Feb 24 · domestic: CAN→CTU, CKG→SZX, PEK→XIY, XIY→SHA' },
  ...
  const budget = {
    ...
    chapters: [
      ...
      { id: 'taiwan', days: 17, lodging: 1615, food: 1020, transport: 300, activities: 120, fees: 0, note: '~$95/n · Hualien + Alishan rails · south slow days' },
